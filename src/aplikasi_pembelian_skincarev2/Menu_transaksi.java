...
public class Menu_transaksi extends javax.swing.JFrame {
    ...
    class transaksi extends Menu_transaksi {
        int id_transaksi, id_skincare, harga, jumlah_beli, total_bayar;
        String nama_pelanggan, tanggal, nama_skincare;
        
        public transaksi() {
            this.nama_pelanggan = text_nama_pelanggan.getText();
            String combo = combo_id_skincare.getSelectedItem().toString();
            String[] arr = combo.split(":");
            this.id_skincare = Integer.parseInt(arr[0]);
            try {
    ...
    public void refreshCombo() {
        try {
            ...
            this.rs = this.stat.executeQuery();
            while (rs.next()) {                
                combo_id_skincare.addItem(rs.getString("id_skincare")+":"+
                rs.getString("nama_skincare")+":"+rs.getString("harga"));
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
    ...
    private void initComponents() {
        ...
        combo_id_skincare = new javax.swing.JComboBox<>();
        jScrollPane1 = new javax.swing.JScrollPane();
        table_transaksi = new javax.swing.JTable();
        jPanel1 = new javax.swing.JPanel();
        text_input = new javax.swing.JButton();
        ...
        jLabel5.setText("ID Skincare");

        combo_id_skincare.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        combo_id_skincare.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                combo_id_skincareActionPerformed(evt);
            }
        });
        ...
        text_input.setFont(new java.awt.Font("Consolas", 1, 24)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(text_input, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(text_input, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(btn_cetak_laporan, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(combo_id_skincare, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(btn_lihat_menu))
                                    .addComponent(text_tanggal, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(text_nama_pelanggan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 546, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addContainerGap())))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(combo_id_skincare, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btn_lihat_menu))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void combo_id_skincareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_id_skincareActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_combo_id_skincareActionPerformed
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        try {
            ...
            this.stat = k.getCon().prepareStatement("update transaksi set nama_pelanggan=?,"
                    + "id_skincare=?, tanggal=?, nama_skincare=?, harga=?, jumlah_beli=?, total_bayar=? "
                    + "where id_transaksi=?");
            this.stat.setString(1, tran.nama_pelanggan);
            this.stat.setInt(2, tran.id_skincare);
            this.stat.setString(3, tran.tanggal);
            this.stat.setString(4, tran.nama_skincare);
    ...
    private void text_inputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_text_inputActionPerformed
        ...
        try {
            ...
            this.stat.setInt(3, tran.id_skincare);
            this.stat.setString(4, tran.tanggal);
            this.stat.setString(5, tran.nama_skincare);
            ...
            int pilihan = JOptionPane.showConfirmDialog(null,
                    ...
                    "\nPembelian: "+tran.jumlah_beli+" "+tran.nama_skincare+
    ...
    private void btn_lihat_menuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_lihat_menuActionPerformed
        // TODO add your handling code here:
        Menu_skincare skin = new Menu_skincare();
        skin.setVisible(true);
        this.setVisible(false);
        skin.btn_delete.setEnabled(true);
        skin.btn_input.setEnabled(true);
        skin.btn_update.setEnabled(true);
        skin.btn_menu_transaksi.setEnabled(true);
    ...
    private javax.swing.JComboBox<String> combo_id_skincare;
    ...
    public javax.swing.JButton text_input;
